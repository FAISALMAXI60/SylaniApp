...
class EliminatedStudents extends React.Component {
    ...
    componentDidMount() {
        ...
        var self = this;
        axios.post(`/course/batch/class/section/student/eliminated`, {
            sectionId
        })
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                </h1><h2 className="text-center m-5 display-4">All Eliminated Students</h2>
...
export default connect(mapStateToProps)(EliminatedStudents);
