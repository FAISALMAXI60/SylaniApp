...
var nameCourse;
class CompletedBatches extends React.Component {
    constructor() {
        super();
        this.state = {
            dataArray: [],
    ...
    componentDidMount() {
        ...
        axios.post(`/course/batch/completed`, {
            courseId
        })
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                <h2 className="text-center m-5 display-4">All Completed Batches</h2>
...
export default connect(mapStateToProps)(CompletedBatches);
