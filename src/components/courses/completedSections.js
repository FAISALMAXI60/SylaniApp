...
class CompleteSections extends React.Component {
    constructor() {
        super();
        this.state = {
            dataArray: [],
    ...
    componentDidMount() {
        ...
        var self = this;
        axios.post(`/course/batch/class/section/completed`, {
            classId
        })
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                </h1><h2 className="text-center m-5 display-4">All Completed Sections</h2>
...
export default connect(mapStateToProps)(CompleteSections);