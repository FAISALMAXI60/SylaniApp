...
class CompletedStudents extends React.Component {
    constructor() {
        super();
        this.state = {
            dataArray: [],
    ...
    componentDidMount() {
        ...
        var self = this;
        axios.post(`/course/batch/class/section/student/completed`, {
            sectionId
        })
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                <h2 className="text-center m-5 display-4">All Completed Students</h2>
                {this.state.dataArray.length == 0 ? <div className="card m-3">
                    ...
                    return <div className="card m-3 p-3 text-center" key={index}>
                        ...
                        <div className="card-body m-2">
                            ...
                            <div className="container-fluid border rounded p-3 m-2">
                                <div className="container-fluid outerEffect">
...
export default connect(mapStateToProps)(CompletedStudents);