...
class CompleteClasses extends React.Component {
    constructor() {
        super();
        this.state = {
            dataArray: [],
    ...
    componentDidMount() {
        ...
        axios.post(`/course/batch/class/completed`, {
            batchId
        })
    ...
    render() {
        ...
        return (
            <div className="container-fluid border">
                ...
                <h2 className="text-center m-5 display-4">All Completed Classes</h2>
...
export default connect(mapStateToProps)(CompleteClasses);