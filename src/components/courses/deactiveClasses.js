...
class DeactiveClasses extends React.Component {
    constructor() {
        super();
        this.state = {
            dataArray: [],
    ...
    componentDidMount() {
        ...
        axios.post(`/course/batch/class/deactivated`, {
            batchId
        })
    ...
    render() {
        ...
        return (
            <div className="container-fluid border">
                ...
                <h2 className="text-center m-5 display-4">All Deactive Classes</h2>
                {this.state.dataArray.length == 0 ? <div className="card m-3">
                    <div className="card-body">
                        <h4 className="card-title text-center outerEffect">There Is No Class</h4>
...
export default connect(mapStateToProps)(DeactiveClasses);